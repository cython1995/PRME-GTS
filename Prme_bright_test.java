...
public class Prme_bright_test {
	...
	static  Map<String,Integer >  new_point_id=new HashMap();
    	 ...
    	 int now =1;
          ...
          for(int u=0;u<total_user;u++){
         	 ...
         	 for(int l=0,r=0;l<testing_checkins[u].size();l++){
         		 ...
         		 String cur=point_id2raw_id[cur_pid];
	...
	public static void main(String[] args) {
      ...
      Prme_bright_test prme=new Prme_bright_test();
      prme.load_trained_result("d://prme_gts_bright.txt");
	  ...
	  prme.load_test_data("d://test_bright.txt");
